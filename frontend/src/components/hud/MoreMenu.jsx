import { ChartLine, GithubLogo, Info } from '@phosphor-icons/react'
...
export function MoreMenu({ onShowTechnicalDetails }) {
  return (
    <div className="flex flex-col">
      ...
      <div className="flex items-start gap-3 px-4 py-3 text-xs leading-relaxed text-[var(--color-signal)]">
        ...
        <p>
          ...
          when an asteroid will hit Earth. Data refreshes automatically once a day.
        </p>
      </div>
    </div>
  )
